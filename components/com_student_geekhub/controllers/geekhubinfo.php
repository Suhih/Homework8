 ...
 */
class Student_geekhubControllerGeekhubinfo extends Student_geekhubController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Geekhubinfo', 'Student_geekhubModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_student_geekhub&view=geekhubinfoform&layout=edit', false));
	}
